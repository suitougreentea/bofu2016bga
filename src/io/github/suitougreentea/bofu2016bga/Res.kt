...
class Res(app: PApplet, minim: Minim) {
  ...
  val gradient = app.loadImage("gradient.png")
  val horLine = app.loadImage("horline.png")
  val horLineSmall = app.loadImage("horlinesmall.png")
  val leftRight = app.loadImage("leftright.png")
  val tri1 = app.loadImage("tri1.png")
  val tri2 = app.loadImage("tri2.png")
  val tri3 = app.loadImage("tri3.png")
  val bmson = app.loadImage("bmsonlogo.png")
}
